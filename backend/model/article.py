...
from sqlalchemy import String, Text, Integer, DateTime, JSON, Index,Boolean
...
class Article(Base):
    ...
    status: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False, comment="0不可视 1可视")
